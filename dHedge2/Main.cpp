...
#include <dHedge2/Top/dHedge2Topology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
int main(int argc, char* argv[]) {
    ...
    dHedge2::setupTopology(inputs);
    dHedge2::startRateGroups(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    dHedge2::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
